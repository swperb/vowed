      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-6">
            <h1 className="font-serif text-2xl font-semibold text-stone-900 mb-1">Start planning</h1>
            <p className="text-stone-500 text-sm">Create your account to get started.</p>
          </div>
          <SignUp
            routing="path"
            path="/sign-up"
